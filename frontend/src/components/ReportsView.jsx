        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          ...
          <div className="flex flex-col md:flex-row items-stretch md:items-end gap-3">
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={() => fetchReports(selectedDate || undefined)}
                className="px-4 py-2 bg-white/10 hover:bg-white/20 rounded-xl transition-all duration-300 flex items-center gap-2 text-sm text-white"
              ...
              <button
                ...
                className="px-4 py-2 bg-cyan-600 hover:bg-cyan-700 rounded-xl transition-all duration-300 flex items-center gap-2 text-sm text-white"
              >
                <svg
                  className="w-4 h-4"
                  fill="none"
